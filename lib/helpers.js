...
module.exports = {
  ...
  convertSwaggerRequestToItem: function (swaggerData, pathItem) {
    ...
    //requestName
    rName = this.options.requestName === 'fallback' ? (operation.operationId || operation.summary || rUrl) :
     (this.options.requestName === 'url' ? rUrl : operation[this.options.requestName]);
    if (!rName) {
